  ...
  const data = [
    {
            "GeneralCommands": [
              ...
              {
                "command": "adb shell am startservice -a com.amazon.device.software.ota.service.CHECK_FOR_UPDATES -n com.amazon.device.software.ota/.OtaService",
                "description": "To check and force app OTA download to your device."
              },
              {
                "command": "adb shell am startservice -a com.amazon.device.software.ota.service.START_OBTRUSIVE -n com.amazon.device.software.ota/.OtaService",
